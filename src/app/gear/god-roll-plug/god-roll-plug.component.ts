...
import { ClarityOverlayComponent } from '@app/gear/clarity-overlay/clarity-overlay.component';
...
export class GodRollPlugComponent {
  ...
  showTooltip(origin: ElementRef, plugIn: InventoryPlug) {
    ...
    const customTooltipPortal = new ComponentPortal(ClarityOverlayComponent);
